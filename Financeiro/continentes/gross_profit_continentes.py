"""
Gross Profit por Continente/Região — evolução anual por Europa, Ásia e América do Norte.
...
pivot = region_gp.pivot(index="Year", columns="Region", values="Gross_Profit").fillna(0)
...
fig.suptitle("Gross Profit por Região — Evolução Anual", fontsize=15, fontweight="bold", y=0.98)
...
ax1.set_ylabel("Gross Profit", fontsize=11)
...
ax2.set_ylabel("Gross Profit", fontsize=11)
...
plt.tight_layout()
out_path = os.path.join(OUTPUT_DIR, "gross_profit_continentes.png")
