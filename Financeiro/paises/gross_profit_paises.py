"""
Gross Profit por País — evolução anual, com 3 plots separados por região.
...
def plot_region(region_name, countries, colors, save_path):
    data = country_gp[country_gp["Region"] == region_name]
    ...
    fig.suptitle(
        f"Gross Profit por País — {region_label}",
...
for region, countries in REGION_MAP.items():
    ...
    out_path    = os.path.join(OUTPUT_DIR, f"gross_profit_paises_{region_slug}.png")
    plot_region(
        region_name=region,
        countries=countries,
